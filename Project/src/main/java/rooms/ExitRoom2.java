...
public class ExitRoom2 implements IRoom {
    ...
    public ArrayList<Tile> buildTiles() {
        ...
        tiles.set(6, new Tile(new Point2D(-1000, -1000), TileType.INVISIBLE));
        ...
        tiles.set(27, new Tile(new Point2D(-1000, -1000), TileType.INVISIBLE));
        tiles.set(26, new Tile(new Point2D(-1000, -1000), TileType.INVISIBLE));
        tiles.set(23, new Tile(new Point2D(-1000, -1000), TileType.INVISIBLE));
        tiles.set(19, new Tile(new Point2D(-1000, -1000), TileType.INVISIBLE));
        ...
        tiles.set(swap, new Tile(originPos));
